...
from src.test.test_lexer import Test_Lexer
from src.test.test_lexer2 import Test_Lexer2
from src.test.test_main import Test_Main
from src.test.test_parser import Test_Parser
from src.test.test_symbol import Test_Symbol_Table
...
class Test_Suite(unittest.TestCase):
    ...
    def suite(self):
        ...
        suite.addTest(Test_Main.test_01_main())
        
        suite.addTest(Test_Parser.test_simple_parse(self))
